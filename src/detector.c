...
// Barcode 
void decode_barcode_file(char *filename, boolean has_region, int left, int right, int top, int bottom) 
{
    ...
    int errorCode = DBR_DecodeFile(barcodeReader, filename, "");
    printf(" Barcode file decoding in %lf milli-seconds.\n", ((double)get_time_point() - time) / 1000);
